...
//https://editor.p5js.org/wwang30/sketches/xzPZwr517
...
function setup() {
  ...
  model.loadData('mouse-notes.json', dataLoaded); //Load the saved data
...
function dataLoaded() {
  ...
  // Automatically call train when data loaded
    state = 'training';
